...
public class Flughafen {
	...
	public static void main(String[] args) {
		...
		Insasse in3 = new Passenger("B�rki", false);
 ...
 System.out.println("\nTest 5: Alle"); f1.printInsassen();
		 
//		 System.out.println("\nTest 6: Alle mit ID"); f1.printInsassenWithId();
//		 
		 System.out.println("\nTest 7: Crew"); f1.printCrew();

		 System.out.println("\nTest 8: First Class"); f1.printFirstClass();
