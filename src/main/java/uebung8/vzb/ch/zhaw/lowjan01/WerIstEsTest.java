...
public class WerIstEsTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("R�ckgabe bei ung�ltigem Index: " + pv.getPerson(12));

		System.out.println("\nTest 5");
		Person p3 = pv.getPersonen2("Franz");
		if (p3 != null) {
		...
		System.out.println("R�ckgabe bei ung�ltigem Namen: " + pv.getPerson("Ulf"));
