...
public class WerIstEs {
	...
	public static void main(String[] args) {
		...
		System.out.println("b)");
		 ...
		 System.out.println(pv.getPerson(1).getMerkmaleAlsCvs());
		 System.out.println(pv.getPerson(3).getMerkmaleAlsCvs());
		 System.out.println(pv.getPerson(5).getMerkmaleAlsCvs());
