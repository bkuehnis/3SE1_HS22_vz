...
public class Person {
	...
	public void schneideHaare() { // Ich habe es leider nicht herausgefunden, wie man die Aufgabe ohne void löst
		String x = "s sind bereits kurz";
		String y = "s Haare wurden geschnitten.";
		if (kurzeHaare == false) {
			kurzeHaare = true;
			...
			System.out.println(name+ "s sind bereits kurz");
		}
