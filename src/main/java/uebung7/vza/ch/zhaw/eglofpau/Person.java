package uebung7.vza.ch.zhaw.eglofpau;
...
public class Person {
	...
	public String getMerkmaleAlsCsv() {
		if (kurzeHaare) {
			return "kurze Haare, "+this.haarfarbe+"e Haare, "+this.augenfarbe+"e Augen";
		} else {
			return "lange Haare, "+this.haarfarbe+"e Haare, "+this.augenfarbe+"e Augen";
		}
	}
}
