...
public class WerIstEs {
	...
	public static void main(String[] args) {
		...
		System.out.println("a)"); // ufgab a
		System.out.println("Anzahl :"+pv.getAnzahl());
		
		
		
		System.out.println("b)"); //ufgab b
		...
		System.out.println("c)"); //ufgab c
		pv.printPersonen();
		
		
		
		System.out.println("d)"); // ufgab d
