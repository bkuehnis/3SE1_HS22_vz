package uebung7.vzb.ch.zhaw.wueesnin;
...
public class Person {
	...
	public void stimmtHaarfarbe(String haarfarbe) {
		System.out.println(
				getName() + " hat " + haarfarbe + "e Haare: " + haarfarbe.equalsIgnoreCase(getHaarfarbe()));
	}
	...
	public String getMerkmaleAlsCsv() {
		return (isKurzeHaare() ? "kurze" : "lange") + " Haare," + getHaarfarbe() + "e Haare,"
				+ getAugenfarbe() + "e Augen";
	}
}