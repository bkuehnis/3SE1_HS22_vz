package uebung12.vza.ch.zhaw.loretyan;
...
public class Reiseanbieter {
	...
	static void printStatistik() {
		...
		for (Flughafen item : flughaefen.values()) {
			numOfConnections += item.getVerbindungen().size();
		}
		System.out.println("Anzahl Verbindungen: " + numOfConnections);
	}
