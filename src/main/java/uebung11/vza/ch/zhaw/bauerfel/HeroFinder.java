...
public class HeroFinder {
	...
	public static void main(String[] args) {
		...
		/*ArrayList<Hero> heldenSucher = new ArrayList<Hero>();
		for (Hero he : heros) {
			heldenSucher.add(he);*/
		
		for ( Hero a : heros ) {
			if (a.getGender().equalsIgnoreCase(gender) && a.getAlignment().equalsIgnoreCase(alignment) && a.getHair().equalsIgnoreCase(hairColor) && a.getEye().equalsIgnoreCase(eyeColor)) {
				System.out.println(a.getPublisher()+": "+a.getName());			
			}
		}
	}
}
