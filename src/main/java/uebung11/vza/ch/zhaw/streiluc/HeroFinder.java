package uebung11.vza.ch.zhaw.streiluc;
...
public class HeroFinder {
	...
	public static void main(String[] args) {
		...
		Arrays.stream(heros)
		.filter(x -> x.getGender().equalsIgnoreCase(gender) && x.getAlignment().equalsIgnoreCase(alignment) && x.getEye().equalsIgnoreCase(eyeColor))
