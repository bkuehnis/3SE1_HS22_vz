package uebung11.vzb.ch.zhaw.landsfre;
...
public class HeroFinder {
	...
	public static void main(String[] args) {
		...
		Arrays.stream(heros)
		.filter(x -> x.getGender().equalsIgnoreCase(gender) && x.getEye().equalsIgnoreCase(eyeColor) 
				&& x.getAlignment().equalsIgnoreCase(alignment) && x.getHair().equalsIgnoreCase(hairColor))
